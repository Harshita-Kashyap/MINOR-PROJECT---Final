      ...
      <div className="flex flex-wrap items-center gap-3 text-sm">
        ...
        {isDashboardPage && user && (
          <div className="flex items-center gap-2">
            <span className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
              {roleLabel}
            </span>
