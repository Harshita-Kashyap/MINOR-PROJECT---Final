...
export default function ApplicantProfile() {
  ...
  const showCategoryCert =
    ...
    form.category === "EWS";
  const showPwdCert = form.isPwd;
  const showExServicemanCert = form.isExServiceman;
  const showPg = form.hasPostGraduation;
  const showPhd = form.hasPhd;
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-gray-100 to-gray-200 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="space-y-6">
            ...
            <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  <Badge
                    className={`border-0 ${profileComplete
          ...
          {saved && (
            <div
              className={`rounded-xl px-4 py-3 text-sm ${profileComplete
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <section className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <SelectField label="PwD" name="isPwd" value={form.isPwd ? "Yes" : "No"} onChange={handleChange} options={["Yes", "No"]} />
                  <SelectField label="Ex-Serviceman" name="isExServiceman" value={form.isExServiceman ? "Yes" : "No"} onChange={handleChange} options={["Yes", "No"]} />
                  <SelectField label="Government Employee" name="isGovtEmployee" value={form.isGovtEmployee ? "Yes" : "No"} onChange={handleChange} options={["Yes", "No"]} />
                </div>
              </section>
              ...
              <section className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <SelectField label="Do you have Post Graduation?" name="hasPostGraduation" value={form.hasPostGraduation ? "Yes" : "No"} onChange={handleChange} options={["Yes", "No"]} />
                  <SelectField label="Do you have PhD?" name="hasPhd" value={form.hasPhd ? "Yes" : "No"} onChange={handleChange} options={["Yes", "No"]} />
                </div>
